...
class TSlotSize : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSlotSize(const TSlotSize&) noexcept;
  TSlotSize& operator=(const TSlotSize&) noexcept;
  TSlotSize() noexcept
            : padded(0),
              logical(0) {
  }

  virtual ~TSlotSize() noexcept;
  int16_t padded;
  int16_t logical;
...
class TColSlotContext : public virtual ::apache::thrift::TBase {
 public:
  ...
  TColSlotContext() noexcept {
  }

  virtual ~TColSlotContext() noexcept;
...
class TCountDistinctDescriptor : public virtual ::apache::thrift::TBase {
 public:
  ...
  TCountDistinctDescriptor(const TCountDistinctDescriptor&) noexcept;
  TCountDistinctDescriptor& operator=(const TCountDistinctDescriptor&) noexcept;
  TCountDistinctDescriptor() noexcept
                           : impl_type(static_cast<TCountDistinctImplType::type>(0)),
                             min_val(0),
                             bitmap_sz_bits(0),
                             approximate(0),
  ...
  virtual ~TCountDistinctDescriptor() noexcept;
  /**
   * 
...
class TResultSetBufferDescriptor : public virtual ::apache::thrift::TBase {
 public:
  ...
  TResultSetBufferDescriptor() noexcept
                             : layout(static_cast<TResultSetLayout::type>(0)),
                               keyless(0),
                               entry_count(0),
                               idx_target_as_key(0),
                               min_val(0),
  ...
  virtual ~TResultSetBufferDescriptor() noexcept;
  /**
   * 
...
class TTargetInfo : public virtual ::apache::thrift::TBase {
 public:
  ...
  TTargetInfo(const TTargetInfo&) noexcept;
  TTargetInfo& operator=(const TTargetInfo&) noexcept;
  TTargetInfo() noexcept
              : is_agg(0),
                kind(static_cast<TAggKind::type>(0)),
                skip_nulls(0),
                is_distinct(0) {
  }

  virtual ~TTargetInfo() noexcept;
  bool is_agg;
  /**
   * 
   * @see TAggKind
...
class TCountDistinctSetStorage : public virtual ::apache::thrift::TBase {
 public:
  ...
  TCountDistinctSetStorage() noexcept
                           : bitmap() {
  }

  virtual ~TCountDistinctSetStorage() noexcept;
  std::string bitmap;
...
class TCountDistinctSet : public virtual ::apache::thrift::TBase {
 public:
  ...
  TCountDistinctSet() noexcept
                    : type(static_cast<TCountDistinctImplType::type>(0)),
                      remote_ptr(0) {
  }

  virtual ~TCountDistinctSet() noexcept;
  /**
   * 
   * @see TCountDistinctImplType
   */
...
class TSerializedRows : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSerializedRows() noexcept
                  : buffers_total_size(0),
                    total_compression_time_ms(0),
                    explanation() {
  }

  virtual ~TSerializedRows() noexcept;
