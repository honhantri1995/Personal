...
const std::map<int, const char*> _TCompletionHintType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kTCompletionHintTypeValues, _kTCompletionHintTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const TCompletionHintType::type& val) {
  std::map<int, const char*>::const_iterator it = _TCompletionHintType_VALUES_TO_NAMES.find(val);
  if (it != _TCompletionHintType_VALUES_TO_NAMES.end()) {
...
TCompletionHint::~TCompletionHint() noexcept {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<TCompletionHintType::type>(ecast0);
