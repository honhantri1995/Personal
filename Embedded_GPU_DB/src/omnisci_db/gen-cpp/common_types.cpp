...
const std::map<int, const char*> _TDatumType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(20, _kTDatumTypeValues, _kTDatumTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _TEncodingType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kTEncodingTypeValues, _kTEncodingTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<TDatumType::type>(ecast0);
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = static_cast<TEncodingType::type>(ecast1);
...
TTypeInfo::TTypeInfo(const TTypeInfo& other2) noexcept {
  type = other2.type;
...
TTypeInfo& TTypeInfo::operator=(const TTypeInfo& other3) noexcept {
  type = other3.type;
