...
int _kTExtArgumentTypeValues[] = {
  ...
  TExtArgumentType::TextEncodingDict8,
  TExtArgumentType::TextEncodingDict16,
  TExtArgumentType::TextEncodingDict32,
...
const std::map<int, const char*> _TExtArgumentType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(45, _kTExtArgumentTypeValues, _kTExtArgumentTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _TOutputBufferSizeType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kTOutputBufferSizeTypeValues, _kTOutputBufferSizeTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
uint32_t TUserDefinedFunction::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("argTypes", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter7)));
    }
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->sizerType = static_cast<TOutputBufferSizeType::type>(ecast10);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            for (_i15 = 0; _i15 < _size11; ++_i15)
            {
              ...
              this->inputArgTypes[_i15] = static_cast<TExtArgumentType::type>(ecast16);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            for (_i21 = 0; _i21 < _size17; ++_i21)
            {
              ...
              this->outputArgTypes[_i21] = static_cast<TExtArgumentType::type>(ecast22);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            for (_i27 = 0; _i27 < _size23; ++_i27)
            {
              ...
              this->sqlArgTypes[_i27] = static_cast<TExtArgumentType::type>(ecast28);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t TUserDefinedTableFunction::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("inputArgTypes", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter29)));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("outputArgTypes", ::apache::thrift::protocol::T_LIST, 5);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter30)));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("sqlArgTypes", ::apache::thrift::protocol::T_LIST, 6);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter31)));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
