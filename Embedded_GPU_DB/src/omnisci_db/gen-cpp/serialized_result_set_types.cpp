...
const std::map<int, const char*> _TResultSetLayout_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kTResultSetLayoutValues, _kTResultSetLayoutNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const TResultSetLayout::type& val) {
  std::map<int, const char*>::const_iterator it = _TResultSetLayout_VALUES_TO_NAMES.find(val);
  if (it != _TResultSetLayout_VALUES_TO_NAMES.end()) {
...
const std::map<int, const char*> _TCountDistinctImplType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kTCountDistinctImplTypeValues, _kTCountDistinctImplTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const TCountDistinctImplType::type& val) {
  std::map<int, const char*>::const_iterator it = _TCountDistinctImplType_VALUES_TO_NAMES.find(val);
  if (it != _TCountDistinctImplType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _TAggKind_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kTAggKindValues, _kTAggKindNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const TAggKind::type& val) {
  std::map<int, const char*>::const_iterator it = _TAggKind_VALUES_TO_NAMES.find(val);
  if (it != _TAggKind_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
TSlotSize::TSlotSize(const TSlotSize& other0) noexcept {
  padded = other0.padded;
  logical = other0.logical;
  __isset = other0.__isset;
}
TSlotSize& TSlotSize::operator=(const TSlotSize& other1) noexcept {
...
TColSlotContext::~TColSlotContext() noexcept {
}
...
TCountDistinctDescriptor::~TCountDistinctDescriptor() noexcept {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->impl_type = static_cast<TCountDistinctImplType::type>(ecast22);
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->device_type = static_cast< ::TDeviceType::type>(ecast23);
...
uint32_t TCountDistinctDescriptor::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->impl_type));
  xfer += oprot->writeFieldEnd();
...
TCountDistinctDescriptor::TCountDistinctDescriptor(const TCountDistinctDescriptor& other24) noexcept {
...
TCountDistinctDescriptor& TCountDistinctDescriptor::operator=(const TCountDistinctDescriptor& other25) noexcept {
...
TResultSetBufferDescriptor::~TResultSetBufferDescriptor() noexcept {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->layout = static_cast<TResultSetLayout::type>(ecast26);
...
uint32_t TResultSetBufferDescriptor::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->layout));
  xfer += oprot->writeFieldEnd();
...
TTargetInfo::~TTargetInfo() noexcept {
}
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->kind = static_cast<TAggKind::type>(ecast47);
...
uint32_t TTargetInfo::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->kind));
  xfer += oprot->writeFieldEnd();
...
TTargetInfo::TTargetInfo(const TTargetInfo& other48) noexcept {
...
TTargetInfo& TTargetInfo::operator=(const TTargetInfo& other49) noexcept {
...
TCountDistinctSetStorage::~TCountDistinctSetStorage() noexcept {
}
...
TCountDistinctSet::~TCountDistinctSet() noexcept {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<TCountDistinctImplType::type>(ecast59);
          this->__isset.type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
TSerializedRows::~TSerializedRows() noexcept {
}
