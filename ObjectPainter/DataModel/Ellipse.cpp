...
CEllipse::CEllipse(POINT inOriginPoint,
...
{
	SetColor();
	::Ellipse(m_hdc, m_originPoint.x, m_originPoint.y, m_originPoint.x + m_width, m_originPoint.y + m_height);
}