...
Link video: https://www.youtube.com/watch?v=R8UGSMf_jss&t=28s

Lưu ý: DevC version mới (> 5.10) có vẻ k còn hỗ trợ BGI, nên nếu đã thực hiện đúng các bước trong video,
nhưng gị lỗi return 3221225477 khi chạy chương trình,
thì hãy thử gỡ DevC đang dùng và cài lại đúng version như trong video (Dev-Cpp 5.9.2 TDM-GCC 4.8.1)