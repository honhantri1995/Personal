...
Translate amongst different languages (English, Japanese, French, Spanish, etc.) in two modes:
  - Popup mode
      + The source text is translated to desintation text which is then displayed in a popup window.
  ...
  - Translate and replace mode
      ...
      + This mode is usedful for reading documents in docx or xlsx format.
